...
export default {
    ...
    default_attrs_opts: is<SharedStepAttrsOption>({
        ...
        startdate: { title: "Date de début", format: 'date', uiType: 'date', minDate: helpers.addDays(new Date(), -45) },
        enddate: { title: "Date de fin", format: 'date', uiType: 'date', minDate: new Date(),  },
