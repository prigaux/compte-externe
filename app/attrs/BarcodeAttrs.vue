...
<fieldset>
  ...
  <div v-if="cardChoice === 'enroll'">
   <my-bootstrap-form-group name="barcode" :label="label.barcode" :validity="validity" v-if="attrs.barcode">
   ...
   <my-bootstrap-form-group name="mifare" :label="label.mifare" :validity="validity" v-if="attrs.mifare">
