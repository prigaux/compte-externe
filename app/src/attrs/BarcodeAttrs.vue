<template>
<fieldset>
  <my-bootstrap-form-group name="cardChoice" :label="default_attrs_title.cardChoice" v-if="attrs.barcode">
  ...
  <div v-if="cardChoice === 'enroll'">
   <my-bootstrap-form-group name="barcode" :label="default_attrs_title.barcode" :validity="validity" v-if="attrs.barcode">
   ...
   <my-bootstrap-form-group name="mifare" :label="default_attrs_title.mifare" :validity="validity" v-if="attrs.mifare">
