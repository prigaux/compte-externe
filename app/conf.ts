...
export default {
    ...
    attr_labels: {
        ...
        supannAutreTelephone: 'Autres téléphones',
    ...
    default_attrs_opts: {
        ...
        facsimileTelephoneNumber: { uiType: "phone" },
        ...
        birthDay: { format: 'date', uiType: 'date', min: new Date('1900'), minYear: 1900, max: new Date(), maxYear: new Date().getUTCFullYear() },
        startdate: { format: 'date', uiType: 'date', min: new Date(), minYear: new Date().getUTCFullYear() },
        enddate: { format: 'date', uiType: 'date', min: new Date(), minYear: new Date().getUTCFullYear() },
        homePostalAddress: { uiType: 'postalAddress' },
        jpegPhoto: { format: 'data-url', uiType: 'photo' },
